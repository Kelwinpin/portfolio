...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gray-950 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 flex flex-col-reverse md:flex-row items-center gap-12 md:gap-16 py-24">
        <div className="flex-1 text-center md:text-left">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 leading-tight">
            <span className="text-transparent bg-clip-text bg-linear-to-r from-violet-400 via-purple-400 to-cyan-400">
              Software Engineer
            </span>
          </h2>
        ...
        <div className="shrink-0 relative">
          <div className="absolute inset-0 rounded-3xl bg-linear-to-b from-violet-600/20 to-cyan-600/10 blur-2xl scale-110" />
          <div className="relative w-64 md:w-72 h-80 md:h-96 rounded-3xl overflow-hidden border border-gray-700 ring-1 ring-violet-500/20">
            <Image
              src={fullBody.image}
              alt={fullBody.alt}
              fill
