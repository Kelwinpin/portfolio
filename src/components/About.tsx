        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex justify-center md:justify-start">
            <div className="relative">
              <div className="w-72 h-72 rounded-3xl bg-linear-to-br from-violet-600/20 to-cyan-600/20 border border-gray-700 flex items-center justify-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-400 leading-relaxed">
              <p>
                ...
                building scalable systems, intelligent applications, and robust
                architectures. Currently working at{" "}
                <span className="text-violet-300 font-medium">Cogna</span> as a
                Mid-Level Software Engineer, where I focus on AI-powered
                products and microservices.
              </p>
              <p>
                My background spans the entire stack — from building RESTful
                APIs with NestJS and Go, to crafting responsive UIs with React
                and Next.js, to integrating LLMs and deploying on AWS and GCP.
                I hold a{" "}
              ...
              <p>
                Passionate about clean code, SOLID principles, and delivering
